#!/usr/bin/env python3
"""
Domain Monitoring Script for GitHub Actions
Checks DropCatch and WHOIS status, sends email alerts
"""
...
def check_whois_status(domain):
    """Check WHOIS status using whois.net API"""
    try:
        # Alternative free WHOIS check
...
Domain: {DOMAIN}
Time: {datetime.now()}
GitHub Action: https://github.com/YOUR_USERNAME/YOUR_REPO/actions
